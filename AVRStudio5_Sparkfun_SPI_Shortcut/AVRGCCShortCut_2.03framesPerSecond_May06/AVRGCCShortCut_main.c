...
char main_menu[] PROGMEM = "\n\r*************************************************************\n\r      Welcome to Seikowave Sen Li Optical-Flow World \n\r*************************************************************\n\r";	
char arrow[] PROGMEM = "->";
...
void SenBurstPixelMenu(void){
  ...
  while(1)
  {
    ...
    {
	  printf245("Please input 2 for PixelBurst once; 0 for Continuous PixelBurst.(1 to stop)\n\r");
    }
  }
}
