...
public:
    ...
    QByteArray getGattCmdPacket_WriteCharacteristicValue_Header()   { return cmdPacket_WriteCharacteristicValue_Header; }
    QByteArray getGattCmdPacket_WriteCharacteristicValue_LedFrequencyServiceHandle()   { return cmdPacket_WriteCharacteristicValue_LedFrequencyServiceHandle; }
    QByteArray getGattCmdPacket_WriteCharacteristicValue_WriteLedRed()    { return cmdPacket_WriteCharacteristicValue_LED_Red; }
    QByteArray getGattCmdPacket_WriteCharacteristicValue_WriteLedGreen()  { return cmdPacket_WriteCharacteristicValue_LED_Green; }
    QByteArray getGattCmdPacket_WriteCharacteristicValue_WriteLedBlue()   { return cmdPacket_WriteCharacteristicValue_LED_Blue; }
...
private:
    ...
    QByteArray cmdPacket_WriteCharacteristicDescriptor_MotionServiceHandle;
    ...
    QByteArray cmdPacket_WriteCharacteristicValue_Header;
    QByteArray cmdPacket_WriteCharacteristicValue_LedFrequencyServiceHandle;
    QByteArray cmdPacket_WriteCharacteristicValue_LED_Red;
    QByteArray cmdPacket_WriteCharacteristicValue_LED_Green;
    QByteArray cmdPacket_WriteCharacteristicValue_LED_Blue;
//    QByteArray
