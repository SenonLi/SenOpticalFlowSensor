...
SenOpticalFlowSensorsMainWindow::SenOpticalFlowSensorsMainWindow(QWidget *parent, QString OF_SensorID) :
  ...
  ,ledFrequencyElapsedTimer(NULL) ,ledFrequencyCount(0)
...
// to Set centralWidget
    ...
    myMotionTrackingWidget->setFixedSize(512,512);
...
//  DonglePackageDecoding     Thread
    ...
    ledFrequencyElapsedTimer = new QElapsedTimer;
    ledFrequencyElapsedTimer->start();
}

SenOpticalFlowSensorsMainWindow::~SenOpticalFlowSensorsMainWindow()
{
    delete ledFrequencyElapsedTimer;
...
void SenOpticalFlowSensorsMainWindow::initMetaSerialConnections()
{
    ...
    connect(metaDongleDecodingObject, SIGNAL(emitSL_GattCMD_LED_FrequencyServiceActive()), this, SLOT(slotSL_GattCMD_LED_FrequencyServiceActive()), Qt::QueuedConnection);
    connect(metaDongleDecodingObject, SIGNAL(emitSL_GattCMD_LED_WriteLedRed()), this, SLOT(slotSL_GattCMD_LED_WriteLedRed()), Qt::QueuedConnection);
    connect(metaDongleDecodingObject, SIGNAL(emitSL_GattCMD_LED_WriteLedGreen()), this, SLOT(slotSL_GattCMD_LED_WriteLedGreen()), Qt::QueuedConnection);
    connect(metaDongleDecodingObject, SIGNAL(emitSL_GattCMD_LED_WriteLedBlue()), this, SLOT(slotSL_GattCMD_LED_WriteLedBlue()), Qt::QueuedConnection);
