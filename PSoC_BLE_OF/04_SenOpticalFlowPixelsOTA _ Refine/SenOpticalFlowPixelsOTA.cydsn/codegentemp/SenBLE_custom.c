...
const CYBLE_CUSTOMS_T cyBle_customs[0x03u] = {
    ...
    /* RGB LED service */
    {
        0x000Cu, /* Handle of the RGB LED service */ 
        {

            /* RGB LED Control characteristic */
            {
                0x000Eu, /* Handle of the RGB LED Control characteristic */ 
    ...
    /* SenMotionBurst service */
    {
        0x0010u, /* Handle of the SenMotionBurst service */ 
        {

            /* MotionBurst characteristic */
            {
                0x0012u, /* Handle of the MotionBurst characteristic */ 
    ...
    /* SenImageBurst service */
    {
        0x0014u, /* Handle of the SenImageBurst service */ 
        {

            /* ImageBurst characteristic */
            {
                0x0016u, /* Handle of the ImageBurst characteristic */ 
