...
#define CYBLE_RGB_LED_SERVICE_INDEX   (0x00u) /* Index of RGB LED service in the cyBle_customs array */
#define CYBLE_RGB_LED_RGB_LED_CONTROL_CHAR_INDEX   (0x00u) /* Index of RGB LED Control characteristic */
#define CYBLE_RGB_LED_RGB_LED_CONTROL_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */

#define CYBLE_SENMOTIONBURST_SERVICE_INDEX   (0x01u) /* Index of SenMotionBurst service in the cyBle_customs array */
#define CYBLE_SENMOTIONBURST_MOTIONBURST_CHAR_INDEX   (0x00u) /* Index of MotionBurst characteristic */
#define CYBLE_SENMOTIONBURST_MOTIONBURST_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */

#define CYBLE_SENIMAGEBURST_SERVICE_INDEX   (0x02u) /* Index of SenImageBurst service in the cyBle_customs array */
#define CYBLE_SENIMAGEBURST_IMAGEBURST_CHAR_INDEX   (0x00u) /* Index of ImageBurst characteristic */
#define CYBLE_SENIMAGEBURST_IMAGEBURST_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */


#define CYBLE_RGB_LED_SERVICE_HANDLE   (0x000Cu) /* Handle of RGB LED service */
#define CYBLE_RGB_LED_RGB_LED_CONTROL_CHAR_HANDLE   (0x000Eu) /* Handle of RGB LED Control characteristic */
#define CYBLE_RGB_LED_RGB_LED_CONTROL_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x000Fu) /* Handle of Characteristic User Description descriptor */

#define CYBLE_SENMOTIONBURST_SERVICE_HANDLE   (0x0010u) /* Handle of SenMotionBurst service */
#define CYBLE_SENMOTIONBURST_MOTIONBURST_CHAR_HANDLE   (0x0012u) /* Handle of MotionBurst characteristic */
#define CYBLE_SENMOTIONBURST_MOTIONBURST_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0013u) /* Handle of Client Characteristic Configuration descriptor */

#define CYBLE_SENIMAGEBURST_SERVICE_HANDLE   (0x0014u) /* Handle of SenImageBurst service */
#define CYBLE_SENIMAGEBURST_IMAGEBURST_CHAR_HANDLE   (0x0016u) /* Handle of ImageBurst characteristic */
#define CYBLE_SENIMAGEBURST_IMAGEBURST_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0017u) /* Handle of Client Characteristic Configuration descriptor */
