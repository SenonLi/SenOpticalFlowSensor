...
static void SPI_Master_ScbModeStop(void)
{
    ...
    *******************************************************************************/
    void SPI_Master_SetPins(uint32 mode, uint32 subMode, uint32 uartEnableMask)
    {
        ...
        {
            hsiomSel[i]  = SPI_Master_HSIOM_DEF_SEL;
        ...
        {
            hsiomSel[SPI_Master_RX_SDA_MOSI_PIN_INDEX] = SPI_Master_HSIOM_I2C_SEL;
            hsiomSel[SPI_Master_TX_SCL_MISO_PIN_INDEX] = SPI_Master_HSIOM_I2C_SEL;
        ...
        {
            hsiomSel[SPI_Master_RX_SDA_MOSI_PIN_INDEX] = SPI_Master_HSIOM_SPI_SEL;
            hsiomSel[SPI_Master_TX_SCL_MISO_PIN_INDEX] = SPI_Master_HSIOM_SPI_SEL;
            hsiomSel[SPI_Master_CTS_SCLK_PIN_INDEX] = SPI_Master_HSIOM_SPI_SEL;
            ...
            if (SPI_Master_SPI_SLAVE == subMode)
            {
                ...
                hsiomSel[SPI_Master_RTS_SS0_PIN_INDEX] = SPI_Master_HSIOM_SPI_SEL;
            ...
            else /* (Master) */
            {
                ...
                hsiomSel [SPI_Master_SS1_PIN_INDEX] = SPI_Master_HSIOM_SPI_SEL;
                ...
                hsiomSel [SPI_Master_SS2_PIN_INDEX] = SPI_Master_HSIOM_SPI_SEL;
                ...
                hsiomSel [SPI_Master_SS3_PIN_INDEX] = SPI_Master_HSIOM_SPI_SEL;
        ...
        else /* UART */
        {
            ...
            {
                /* SmartCard */
                hsiomSel[SPI_Master_TX_SCL_MISO_PIN_INDEX] = SPI_Master_HSIOM_UART_SEL;
                pinsDm  [SPI_Master_TX_SCL_MISO_PIN_INDEX] = SPI_Master_PIN_DM_OD_LO;
            }
            else /* Standard or IrDA */
            {
                ...
                {
                    hsiomSel[SPI_Master_RX_SDA_MOSI_PIN_INDEX] = SPI_Master_HSIOM_UART_SEL;
                    pinsDm  [SPI_Master_RX_SDA_MOSI_PIN_INDEX] = SPI_Master_PIN_DM_DIG_HIZ;
                }
                ...
                if (SPI_Master_UART_MODE_STD == subMode)
                {
                    if (0u != (SPI_Master_UART_CTS_PIN_ENABLE & uartEnableMask))
                    {
                        ...
                        hsiomSel[SPI_Master_CTS_SCLK_PIN_INDEX] = SPI_Master_HSIOM_UART_SEL;
                        pinsDm  [SPI_Master_CTS_SCLK_PIN_INDEX] = SPI_Master_PIN_DM_DIG_HIZ;
                    }
                    ...
                    if (0u != (SPI_Master_UART_RTS_PIN_ENABLE & uartEnableMask))
                    {
                        ...
                        hsiomSel[SPI_Master_RTS_SS0_PIN_INDEX] = SPI_Master_HSIOM_UART_SEL;
                        pinsDm  [SPI_Master_RTS_SS0_PIN_INDEX] = SPI_Master_PIN_DM_STRONG;
